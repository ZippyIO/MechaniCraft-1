...
public class TileEntityObsidianChest extends TileEntity implements IInventory
{
    ...
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityObsidianChest adjacentChestZPosition;
    ...
    public TileEntityObsidianChest(int par1)
    {
    ...
    {
        return this.isInvNameLocalized() ? this.customName : "Obsidian Chest";
    }
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if (par1NBTTagCompound.hasKey("Obsidian Chest"))
        {
            this.customName = par1NBTTagCompound.getString("Obsidian Chest");
        }
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            par1NBTTagCompound.setString("Obsidian Chest", this.customName);
        }
    }
    ...
    private void func_90009_a(TileEntityObsidianChest par1TileEntityChest, int par2)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntityObsidianChest)this.worldObj.getBlockTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntityObsidianChest)this.worldObj.getBlockTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntityObsidianChest)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPosition = (TileEntityObsidianChest)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean func_94044_a(int par1, int par2, int par3)
    {
        ...
        return block != null && block instanceof ObsidianChest ? ((ObsidianChest)block).chestType == this.getChestType() : false;
    }
    ...
    {
        if (this.getBlockType() != null && this.getBlockType() instanceof ObsidianChest)
        {
            --this.numUsingPlayers;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID, 1, this.numUsingPlayers);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID);
    ...
    public int getChestType()
    {
        if (this.cachedChestType == -1)
        {
            ...
            this.cachedChestType = ((ObsidianChest)this.getBlockType()).chestType;
        }
