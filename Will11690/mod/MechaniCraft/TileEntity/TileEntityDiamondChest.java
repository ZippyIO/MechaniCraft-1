...
public class TileEntityDiamondChest extends TileEntity implements IInventory
{
    ...
    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityDiamondChest adjacentChestZPosition;
    ...
    public TileEntityDiamondChest(int par1)
    {
    ...
    {
        return this.isInvNameLocalized() ? this.customName : "Diamond Chest";
    }
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if (par1NBTTagCompound.hasKey("Diamond Chest"))
        {
            this.customName = par1NBTTagCompound.getString("Diamond Chest");
        }
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            par1NBTTagCompound.setString("Diamond Chest", this.customName);
        }
    }
    ...
    private void func_90009_a(TileEntityDiamondChest par1TileEntityChest, int par2)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntityDiamondChest)this.worldObj.getBlockTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntityDiamondChest)this.worldObj.getBlockTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntityDiamondChest)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPosition = (TileEntityDiamondChest)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean func_94044_a(int par1, int par2, int par3)
    {
        ...
        return block != null && block instanceof DiamondChest ? ((DiamondChest)block).chestType == this.getChestType() : false;
    }
    ...
    {
        if (this.getBlockType() != null && this.getBlockType() instanceof DiamondChest)
        {
            --this.numUsingPlayers;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID, 1, this.numUsingPlayers);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID);
    ...
    public int getChestType()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof DiamondChest))
            {
                return 0;
            }

            this.cachedChestType = ((DiamondChest)this.getBlockType()).chestType;
        }
