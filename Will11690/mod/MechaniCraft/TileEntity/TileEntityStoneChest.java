...
public class TileEntityStoneChest extends TileEntity implements IInventory
{
    ...
    public TileEntityStoneChest adjacentChestZNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityStoneChest adjacentChestXPos;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityStoneChest adjacentChestXNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityStoneChest adjacentChestZPosition;
    ...
    public TileEntityStoneChest(int par1)
    {
    ...
    {
        return this.isInvNameLocalized() ? this.customName : "Stone Chest";
    }
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if (par1NBTTagCompound.hasKey("Stone Chest"))
        {
            this.customName = par1NBTTagCompound.getString("Stone Chest");
        }
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            par1NBTTagCompound.setString("Stone Chest", this.customName);
        }
    }
    ...
    private void func_90009_a(TileEntityStoneChest par1TileEntityChest, int par2)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntityStoneChest)this.worldObj.getBlockTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntityStoneChest)this.worldObj.getBlockTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntityStoneChest)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPosition = (TileEntityStoneChest)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean func_94044_a(int par1, int par2, int par3)
    {
        ...
        return block != null && block instanceof StoneChest ? ((StoneChest)block).chestType == this.getChestType() : false;
    }
    ...
    {
        if (this.getBlockType() != null && this.getBlockType() instanceof StoneChest)
        {
            --this.numUsingPlayers;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID, 1, this.numUsingPlayers);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID);
    ...
    public int getChestType()
    {
        if (this.cachedChestType == -1)
        {
            ...
            this.cachedChestType = ((StoneChest)this.getBlockType()).chestType;
        }
