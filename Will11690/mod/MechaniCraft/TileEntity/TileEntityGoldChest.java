...
public class TileEntityGoldChest extends TileEntity implements IInventory
{
    ...
    public TileEntityGoldChest adjacentChestZNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityGoldChest adjacentChestXPos;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityGoldChest adjacentChestXNeg;

    /** Contains the chest tile located adjacent to this one (if any) */
    public TileEntityGoldChest adjacentChestZPosition;
    ...
    public TileEntityGoldChest(int par1)
    {
    ...
    {
        return this.isInvNameLocalized() ? this.customName : "Gold Chest";
    }
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if (par1NBTTagCompound.hasKey("Gold Chest"))
        {
            this.customName = par1NBTTagCompound.getString("Gold Chest");
        }
    ...
    public void writeToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        {
            par1NBTTagCompound.setString("Gold Chest", this.customName);
        }
    }
    ...
    private void func_90009_a(TileEntityGoldChest par1TileEntityChest, int par2)
    {
    ...
    public void checkForAdjacentChests()
    {
        if (!this.adjacentChestChecked)
        {
            ...
            {
                this.adjacentChestXNeg = (TileEntityGoldChest)this.worldObj.getBlockTileEntity(this.xCoord - 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord + 1, this.yCoord, this.zCoord))
            {
                this.adjacentChestXPos = (TileEntityGoldChest)this.worldObj.getBlockTileEntity(this.xCoord + 1, this.yCoord, this.zCoord);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord - 1))
            {
                this.adjacentChestZNeg = (TileEntityGoldChest)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord - 1);
            }

            if (this.func_94044_a(this.xCoord, this.yCoord, this.zCoord + 1))
            {
                this.adjacentChestZPosition = (TileEntityGoldChest)this.worldObj.getBlockTileEntity(this.xCoord, this.yCoord, this.zCoord + 1);
            }
    ...
    private boolean func_94044_a(int par1, int par2, int par3)
    {
        ...
        return block != null && block instanceof GoldChest ? ((GoldChest)block).chestType == this.getChestType() : false;
    }
    ...
    {
        if (this.getBlockType() != null && this.getBlockType() instanceof GoldChest)
        {
            --this.numUsingPlayers;
            this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID, 1, this.numUsingPlayers);
            this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID);
    ...
    public int getChestType()
    {
        ...
        {
            if (this.worldObj == null || !(this.getBlockType() instanceof GoldChest))
            {
                return 0;
            }

            this.cachedChestType = ((GoldChest)this.getBlockType()).chestType;
        }
