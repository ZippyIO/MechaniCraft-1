package Will11690.mod.MechaniCraft.Chests;
...
public class DiamondChest extends BlockContainer
{
    ...
    public DiamondChest(int par1, int par2)
    {
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntityDiamondChest)par1World.getBlockTileEntity(par2, par3, par4)).setChestGuiName(par6ItemStack.getDisplayName());
        }
    }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        TileEntityDiamondChest tileentitychest = (TileEntityDiamondChest)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        Object object = (TileEntityDiamondChest)par1World.getBlockTileEntity(par2, par3, par4);
        ...
        else
        {
            if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("Large Diamond Chest", (TileEntityDiamondChest)par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory)object);
            }

            if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("Large Diamond Chest", (IInventory)object, (TileEntityDiamondChest)par1World.getBlockTileEntity(par2 + 1, par3, par4));
            }

            if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID)
            {
                object = new InventoryLargeChest("Large Diamond Chest", (TileEntityDiamondChest)par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory)object);
            }

            if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID)
            {
                object = new InventoryLargeChest("Large Diamond Chest", (IInventory)object, (TileEntityDiamondChest)par1World.getBlockTileEntity(par2, par3, par4 + 1));
            }
    ...
    {
    	TileEntityDiamondChest tileentitychest = new TileEntityDiamondChest();
    ...
    public int isProvidingWeakPower(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        {
            int i1 = ((TileEntityDiamondChest)par1IBlockAccess.getBlockTileEntity(par2, par3, par4)).numUsingPlayers;
