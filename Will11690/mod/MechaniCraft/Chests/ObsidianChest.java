...
public class ObsidianChest extends BlockContainer
{
    ...
    public ObsidianChest(int par1, int par2)
    {
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLivingBase, ItemStack par6ItemStack)
    {
        ...
        {
            ((TileEntityObsidianChest)par1World.getBlockTileEntity(par2, par3, par4)).setChestGuiName(par6ItemStack.getDisplayName());
        }
    }
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
    {
        ...
        TileEntityObsidianChest tileentitychest = (TileEntityObsidianChest)par1World.getBlockTileEntity(par2, par3, par4);
    ...
    {
        Object object = (TileEntityObsidianChest)par1World.getBlockTileEntity(par2, par3, par4);
        ...
        else
        {
            if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("Large Obsidian Chest", (TileEntityObsidianChest)par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory)object);
            }

            if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID)
            {
                object = new InventoryLargeChest("Large Obsidian Chest", (IInventory)object, (TileEntityObsidianChest)par1World.getBlockTileEntity(par2 + 1, par3, par4));
            }

            if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID)
            {
                object = new InventoryLargeChest("Large Obsidian Chest", (TileEntityObsidianChest)par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory)object);
            }

            if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID)
            {
                object = new InventoryLargeChest("Large Obsidian Chest", (IInventory)object, (TileEntityObsidianChest)par1World.getBlockTileEntity(par2, par3, par4 + 1));
            }
    ...
    public int isProvidingWeakPower(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
    {
        ...
        {
            int i1 = ((TileEntityObsidianChest)par1IBlockAccess.getBlockTileEntity(par2, par3, par4)).numUsingPlayers;
