...
public class RubyOre extends Block{
	...
	public RubyOre(int ID, int TEXTURE) {
		super(ID, Material.rock);
	}
	public int idDropped(int par1, Random par2Random, int par3)
    {
        return Will11690.mod.MechaniCraft.Common.MechaniCraft.RubyGem.itemID;
    }
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("will11690:RubyOre");
	}
