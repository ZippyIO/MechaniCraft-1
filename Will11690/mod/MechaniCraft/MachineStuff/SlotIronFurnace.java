...
public class SlotIronFurnace extends Slot
{
    ...
    public SlotIronFurnace(EntityPlayer par1EntityPlayer, IInventory par2IInventory, int par3, int par4, int par5)
    {
    ...
    protected void onCrafting(ItemStack par1ItemStack)
    {
        ...
        if (!this.thePlayer.worldObj.isRemote)
        {
            ...
            float f = IronFurnaceRecipes.smelting().getExperience(par1ItemStack);
            int j;
