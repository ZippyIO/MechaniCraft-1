...
public class IronFurnaceRecipes
{
    ...
    private IronFurnaceRecipes()
    {
        ...
        //My Stuff
        this.addSmelting(Item.eyeOfEnder.itemID, new ItemStack(MechaniCraft.EndIngot), 0.5F);
        this.addSmelting(MechaniCraft.ObsidianChunk.itemID, new ItemStack(MechaniCraft.ObsidianIngot), 0.5F);
        this.addSmelting(Block.glass.blockID, new ItemStack(MechaniCraft.GlassIngot), 0.5F);
        this.addSmelting(Block.obsidian.blockID, new ItemStack(MechaniCraft.ObsidianChunk, 4), 0.5F);
        this.addSmelting(MechaniCraft.CopperOre.blockID, new ItemStack(MechaniCraft.CopperIngot), 0.5F);
        this.addSmelting(MechaniCraft.TinOre.blockID, new ItemStack(MechaniCraft.TinIngot), 0.5F);
        this.addSmelting(MechaniCraft.TinDust.itemID, new ItemStack(MechaniCraft.TinIngot), 0.25F);
        this.addSmelting(MechaniCraft.IronDust.itemID, new ItemStack(Item.ingotIron), 0.25F);
        this.addSmelting(MechaniCraft.GoldDust.itemID, new ItemStack(Item.ingotGold), 0.25F);
        this.addSmelting(MechaniCraft.CopperDust.itemID, new ItemStack(MechaniCraft.CopperIngot), 0.25F);
        this.addSmelting(MechaniCraft.RawLambchop.itemID, new ItemStack(MechaniCraft.CookedLambchop), 0.5F);
    }
