...
{
    private static final ResourceLocation RES_TRAPPED_DOUBLE = new ResourceLocation("will11690","textures/entity/chest/LargeIronChest.png");
    private static final ResourceLocation RES_CHRISTMAS_DOUBLE = new ResourceLocation("will11690","textures/entity/chest/LargeIronChest.png");
    private static final ResourceLocation RES_NORMAL_DOUBLE = new ResourceLocation("will11690","textures/entity/chest/LargeIronChest.png");
    private static final ResourceLocation RES_TRAPPED_SINGLE = new ResourceLocation("will11690","textures/entity/chest/IronChest.png");
    private static final ResourceLocation RES_CHRISTMAS_SINGLE = new ResourceLocation("will11690","textures/entity/chest/IronChest.png");
    private static final ResourceLocation RES_NORMAL_SINGLE = new ResourceLocation("will11690","textures/entity/chest/IronChest.png");
     ...
     */
    public void renderTileEntityChestAt(TileEntityIronChest par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof IronChest && i == 0)
            {
                try
                {
                    ((IronChest)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                }
    ...
    {
        this.renderTileEntityChestAt((TileEntityIronChest)par1TileEntity, par2, par4, par6, par8);
    }
}
