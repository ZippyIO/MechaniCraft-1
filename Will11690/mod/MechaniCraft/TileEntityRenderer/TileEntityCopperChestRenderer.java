...
public class TileEntityCopperChestRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation RES_TRAPPED_DOUBLE = new ResourceLocation("will11690","textures/entity/chest/LargeCopperChest.png");
    private static final ResourceLocation RES_CHRISTMAS_DOUBLE = new ResourceLocation("will11690","textures/entity/chest/LargeCopperChest.png");
    private static final ResourceLocation RES_NORMAL_DOUBLE = new ResourceLocation("will11690","textures/entity/chest/LargeCopperChest.png");
    private static final ResourceLocation RES_TRAPPED_SINGLE = new ResourceLocation("will11690","textures/entity/chest/CopperChest.png");
    private static final ResourceLocation RES_CHRISTMAS_SINGLE = new ResourceLocation("will11690","textures/entity/chest/CopperChest.png");
    private static final ResourceLocation RES_NORMAL_SINGLE = new ResourceLocation("will11690","textures/entity/chest/CopperChest.png");
    ...
    public TileEntityCopperChestRenderer()
    {
     ...
     */
    public void renderTileEntityChestAt(TileEntityCopperChest par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof CopperChest && i == 0)
            {
                try
                {
                    ((CopperChest)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                }
    ...
    {
        this.renderTileEntityChestAt((TileEntityCopperChest)par1TileEntity, par2, par4, par6, par8);
    }
}
