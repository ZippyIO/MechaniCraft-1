...
public class TileEntityStoneChestRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation RES_TRAPPED_DOUBLE = new ResourceLocation("will11690","textures/entity/chest/LargeStoneChest.png");
    private static final ResourceLocation RES_CHRISTMAS_DOUBLE = new ResourceLocation("will11690","textures/entity/chest/LargeStoneChest.png");
    private static final ResourceLocation RES_NORMAL_DOUBLE = new ResourceLocation("will11690","textures/entity/chest/LargeStoneChest.png");
    private static final ResourceLocation RES_TRAPPED_SINGLE = new ResourceLocation("will11690","textures/entity/chest/StoneChest.png");
    private static final ResourceLocation RES_CHRISTMAS_SINGLE = new ResourceLocation("will11690","textures/entity/chest/StoneChest.png");
    private static final ResourceLocation RES_NORMAL_SINGLE = new ResourceLocation("will11690","textures/entity/chest/StoneChest.png");
     ...
     */
    public void renderTileEntityChestAt(TileEntityStoneChest par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof StoneChest && i == 0)
            {
                try
                {
                    ((StoneChest)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                }
    ...
    {
        this.renderTileEntityChestAt((TileEntityStoneChest)par1TileEntity, par2, par4, par6, par8);
    }
}
