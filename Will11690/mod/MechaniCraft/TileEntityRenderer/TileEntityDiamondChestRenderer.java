...
public class TileEntityDiamondChestRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation RES_TRAPPED_DOUBLE = new ResourceLocation("will11690","textures/entity/chest/LargeDiamondChest.png");
    private static final ResourceLocation RES_CHRISTMAS_DOUBLE = new ResourceLocation("will11690","textures/entity/chest/LargeDiamondChest.png");
    private static final ResourceLocation RES_NORMAL_DOUBLE = new ResourceLocation("will11690","textures/entity/chest/LargeDiamondChest.png");
    private static final ResourceLocation RES_TRAPPED_SINGLE = new ResourceLocation("will11690","textures/entity/chest/DiamondChest.png");
    private static final ResourceLocation RES_CHRISTMAS_SINGLE = new ResourceLocation("will11690","textures/entity/chest/DiamondChest.png");
    private static final ResourceLocation RES_NORMAL_SINGLE = new ResourceLocation("will11690","textures/entity/chest/DiamondChest.png");
     ...
     */
    public void renderTileEntityChestAt(TileEntityDiamondChest par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof DiamondChest && i == 0)
            {
                try
                {
                    ((DiamondChest)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                }
    ...
    {
        this.renderTileEntityChestAt((TileEntityDiamondChest)par1TileEntity, par2, par4, par6, par8);
    }
}
