...
public class TileEntityGoldChestRenderer extends TileEntitySpecialRenderer
{
    private static final ResourceLocation RES_TRAPPED_DOUBLE = new ResourceLocation("will11690","textures/entity/chest/LargeGoldChest.png");
    private static final ResourceLocation RES_CHRISTMAS_DOUBLE = new ResourceLocation("will11690","textures/entity/chest/LargeGoldChest.png");
    private static final ResourceLocation RES_NORMAL_DOUBLE = new ResourceLocation("will11690","textures/entity/chest/LargeGoldChest.png");
    private static final ResourceLocation RES_TRAPPED_SINGLE = new ResourceLocation("will11690","textures/entity/chest/GoldChest.png");
    private static final ResourceLocation RES_CHRISTMAS_SINGLE = new ResourceLocation("will11690","textures/entity/chest/GoldChest.png");
    private static final ResourceLocation RES_NORMAL_SINGLE = new ResourceLocation("will11690","textures/entity/chest/GoldChest.png");
    ...
    public TileEntityGoldChestRenderer()
    {
     ...
     */
    public void renderTileEntityChestAt(TileEntityGoldChest par1TileEntityChest, double par2, double par4, double par6, float par8)
    {
        int i;
        ...
        else
        {
            ...
            if (block instanceof GoldChest && i == 0)
            {
                try
                {
                    ((GoldChest)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
                }
    ...
    {
        this.renderTileEntityChestAt((TileEntityGoldChest)par1TileEntity, par2, par4, par6, par8);
    }
}
